...
// $3 - String - e-Tag, only required when updating 
// ----------------------------------------------------
...
Else 
	$vc_headers.push(New object:C1471("name"; "If-Match"; "value"; ""))
End if 

$0:=ZAL_Make_Request($vt_url; HTTP PUT method:K71:6; ""; $1; $vc_headers)
